...
const IPAD_REPAIRS = {
  'iPad 10th gen': [{ name: 'Screen', sub: 'Outer glass/digitiser only', time: '1–2 hrs', price: 119 }, { name: 'Screen + LCD', sub: 'Full display — for dark spots or lines', time: '2–3 hrs', price: 269 }, { name: 'Battery replacement', time: '1–2 hrs', price: 149 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 9th gen':  [{ name: 'Screen', sub: 'Outer glass/digitiser only', time: '1–2 hrs', price: 119 }, { name: 'Screen + LCD', sub: 'Full display — for dark spots or lines', time: '2–3 hrs', price: 179 }, { name: 'Battery replacement', time: '1–2 hrs', price: 115 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 8th gen':  [{ name: 'Screen', sub: 'Outer glass/digitiser only', time: '1–2 hrs', price: 119 }, { name: 'Screen + LCD', sub: 'Full display — for dark spots or lines', time: '2–3 hrs', price: 179 }, { name: 'Battery replacement', time: '1–2 hrs', price: 115 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 7th gen':  [{ name: 'Screen', sub: 'Outer glass/digitiser only', time: '1–2 hrs', price: 119 }, { name: 'Screen + LCD', sub: 'Full display — for dark spots or lines', time: '2–3 hrs', price: 179 }, { name: 'Battery replacement', time: '1–2 hrs', price: 115 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 6th gen':  [{ name: 'Screen', sub: 'Outer glass/digitiser only', time: '1–2 hrs', price: 99 },  { name: 'Screen + LCD', sub: 'Full display — for dark spots or lines', time: '2–3 hrs', price: 169 }, { name: 'Battery replacement', time: '1–2 hrs', price: 99 },  { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 5th gen':  [{ name: 'Screen', sub: 'Outer glass/digitiser only', time: '1–2 hrs', price: 99 },  { name: 'Screen + LCD', sub: 'Full display — for dark spots or lines', time: '2–3 hrs', price: 169 }, { name: 'Battery replacement', time: '1–2 hrs', price: 99 },  { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 4th gen':  [{ name: 'Battery replacement', time: '1–2 hrs', price: 99 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad 3rd gen':  [{ name: 'Battery replacement', time: '1–2 hrs', price: 99 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Air 5th gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 225 }, { name: 'Battery replacement', time: '1–2 hrs', price: 129 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Air 4th gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 225 }, { name: 'Battery replacement', time: '1–2 hrs', price: 129 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Air 3rd gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 189 }, { name: 'Battery replacement', time: '1–2 hrs', price: 119 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Air 2nd gen': [{ name: 'Battery replacement', time: '1–2 hrs', price: 99 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Air 1st gen': [{ name: 'Battery replacement', time: '1–2 hrs', price: 99 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 12.9" 5th gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 329 }, { name: 'Battery replacement', time: '1–2 hrs', price: 139 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 11" 5th gen':   [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 299 }, { name: 'Battery replacement', time: '1–2 hrs', price: 139 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 12.9" 4th gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 329 }, { name: 'Battery replacement', time: '1–2 hrs', price: 139 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 11" 4th gen':   [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 299 }, { name: 'Battery replacement', time: '1–2 hrs', price: 139 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 12.9" 3rd gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 329 }, { name: 'Battery replacement', time: '1–2 hrs', price: 129 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 11" 3rd gen':   [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 275 }, { name: 'Battery replacement', time: '1–2 hrs', price: 129 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 12.9" 2nd gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 329 }, { name: 'Battery replacement', time: '1–2 hrs', price: 129 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
  'iPad Pro 10.5" 2nd gen': [{ name: 'Screen', sub: 'Full screen replacement', time: '1–2 hrs', price: 275 }, { name: 'Battery replacement', time: '1–2 hrs', price: 119 }, { name: 'Dock service', sub: 'Cleans out your charging port and removes anything stuck inside', time: '15–20 min', price: 20 }, { name: 'Motherboard / water damage', time: '4–7 days', price: null, quote: true }],
