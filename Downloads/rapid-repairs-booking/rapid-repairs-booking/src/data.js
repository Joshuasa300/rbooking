...
export const iphoneSeries = [
  { id: 'std',    name: 'iPhone',         sub: 'Standard lineup',  svgType: 'std' },
  { id: 'pro',    name: 'iPhone Pro',     sub: 'Pro lineup',       svgType: 'pro' },
  { id: 'promax', name: 'iPhone Pro Max', sub: 'Pro Max lineup',   svgType: 'promax' },
  { id: 'mini',   name: 'iPhone mini / Plus / e', sub: 'mini, Plus & e models', svgType: 'mini' },
];
...
export const iphoneModels = {
  std: [
    { name: 'iPhone 16',  year: '2024' }, { name: 'iPhone 15',  year: '2023' },
    { name: 'iPhone 14',  year: '2022' }, { name: 'iPhone 13',  year: '2021' },
  ...
  pro: [
    ...
    { name: 'iPhone 14 Pro', year: '2022' }, { name: 'iPhone 13 Pro', year: '2021' },
    { name: 'iPhone 12 Pro', year: '2020' }, { name: 'iPhone 11 Pro', year: '2019' },
  ],
  promax: [
    { name: 'iPhone 16 Pro Max', year: '2024' }, { name: 'iPhone 15 Pro Max', year: '2023' },
    { name: 'iPhone 14 Pro Max', year: '2022' }, { name: 'iPhone 13 Pro Max', year: '2021' },
    { name: 'iPhone 12 Pro Max', year: '2020' }, { name: 'iPhone 11 Pro Max', year: '2019' },
    { name: 'iPhone XS Max',     year: '2018' },
  ],
  mini: [
    { name: 'iPhone 16 Plus',  year: '2024', svgType: 'plus' },
    { name: 'iPhone 16e',      year: '2025', svgType: 'std'  },
    { name: 'iPhone 15 Plus',  year: '2023', svgType: 'plus' },
...
export const samsungModels = {
  s: [
    { name: 'S25 Ultra', year: '2025', svgType: 'ultra' }, { name: 'S25 Plus', year: '2025', svgType: 'plus' }, { name: 'S25', year: '2025', svgType: 'std' },
    { name: 'S24 Ultra', year: '2024', svgType: 'ultra' }, { name: 'S24 Plus', year: '2024', svgType: 'plus' }, { name: 'S24', year: '2024', svgType: 'std' }, { name: 'S24 FE', year: '2024', svgType: 'std' },
    { name: 'S23 Ultra', year: '2023', svgType: 'ultra' }, { name: 'S23 Plus', year: '2023', svgType: 'plus' }, { name: 'S23', year: '2023', svgType: 'std' }, { name: 'S23 FE', year: '2023', svgType: 'std' },
    { name: 'S22 Ultra', year: '2022', svgType: 'ultra' }, { name: 'S22 Plus', year: '2022', svgType: 'plus' }, { name: 'S22', year: '2022', svgType: 'std' },
    { name: 'S21 Ultra', year: '2021', svgType: 'ultra' }, { name: 'S21 Plus', year: '2021', svgType: 'plus' }, { name: 'S21', year: '2021', svgType: 'std' },
    { name: 'S20 Ultra', year: '2020', svgType: 'ultra' }, { name: 'S20 Plus', year: '2020', svgType: 'plus' }, { name: 'S20', year: '2020', svgType: 'std' }, { name: 'S20 FE', year: '2020', svgType: 'std' },
  ],
  note: [
...
export function getAvailableSlots() {
  ...
  for (let d = 0; d < 7; d++) {
    ...
    slots.push({
      ...
      times: times.filter(() => Math.random() > 0.35),
    });
  }
  return slots;
}
